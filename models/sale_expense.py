...
from sqlalchemy import CheckConstraint, ForeignKey, ForeignKeyConstraint, Numeric, String
...
class SaleExpense(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("type IN ('payment_fee', 'shipping_fee')", name="sale_expense_type_valid"),
    )
